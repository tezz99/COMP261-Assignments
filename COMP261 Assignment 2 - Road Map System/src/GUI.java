...
public abstract class GUI {
    ...
    /**
     * Is called when scroll wheel is moved and is passed the MouseEvent object for that click
     */
    ...
    /**
     *  Is called when mouse is dragged.
     */
    ...
    /**
     * Is called whenever findArticulation Points is pressed
     */
    protected abstract void findArticulationPoints();

    /*
     * Called when route finding mode button is pressed
     */
    protected abstract void changeRouteMode();
	...
	//Added by me
	JButton routeType = new JButton("Distance/Time");
	routeType.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent ev) {
		changeRouteMode();
		redraw();
	    }
	...
	JPanel extraBtns = new JPanel();
	extraBtns.setLayout(new GridLayout(2, 1));
	extraBtns.setMaximumSize(new Dimension(150, 60));
	extraBtns.add(artPts);  //Added by me
	extraBtns.add(routeType); //Added by me
	...
	frame = new JFrame("Auckland Road System");
